...
//       fs.writeJsonSync("./scheduleProofActions.json", scheduleProofActions, { spaces: 2 })
...
//       const data = emitxferProofAction.decodeData(Issuea)
//       const flatact = toObject(emitxferProofAction)
//       flatact.data = data
//       fs.writeJsonSync("./emitxferProofAction.json", flatact, { spaces: 2 })
//       const destinationActions:Action[] = [...scheduleProofActions, emitxferProofAction]
//       // fs.writeJsonSync("./destinationActions.json", destinationActions, { spaces: 2 })
